---
title: "10. CellChat analysis"
author: "Yang Li, Cankun Wang, Faith Brennan"
...
# Chord diagram for Macrophage, Astrocyte, and Microglia in all samples

```{r, eval = F}

# load data
{
  counts.ctrl.00d <- read.table("../data/codes_for_CellChat/counts_control_00d.txt", header = T)
  counts.ctrl.00d <- normalizeData(counts.ctrl.00d)
  meta.ctrl.00d <- read.table("../data/codes_for_CellChat/meta_control_00d.txt", header = T)
  
  counts.ctrl.07d <- read.table("../data/codes_for_CellChat/counts_control_07d.txt", header = T)
  counts.ctrl.07d <- normalizeData(counts.ctrl.07d)
  meta.ctrl.07d <- read.table("../data/codes_for_CellChat/meta_control_07d.txt", header = T)
  
  counts.ctrl.28d <- read.table("../data/codes_for_CellChat/counts_control_28d.txt", header = T)
  counts.ctrl.28d <- normalizeData(counts.ctrl.28d)
  meta.ctrl.28d <- read.table("../data/codes_for_CellChat/meta_control_28d.txt", header = T)
  
  counts.plx.00d <- read.table("../data/codes_for_CellChat/counts_PLX5622_00d.txt", header = T)
  counts.plx.00d <- normalizeData(counts.plx.00d)
  meta.plx.00d <- read.table("../data/codes_for_CellChat/meta_PLX5622_00d.txt", header = T)
  
  counts.plx.07d <- read.table("../data/codes_for_CellChat/counts_PLX5622_07d.txt", header = T)
  counts.plx.07d <- normalizeData(counts.plx.07d)
  meta.plx.07d <- read.table("../data/codes_for_CellChat/meta_PLX5622_07d.txt", header = T)
  
  counts.plx.28d <- read.table("../data/codes_for_CellChat/counts_PLX5622_28d.txt", header = T)
  counts.plx.28d <- normalizeData(counts.plx.28d)
  meta.plx.28d <- read.table("../data/codes_for_CellChat/meta_PLX5622_28d.txt", header = T)
}
...
# Chord diagram for Macrophage, Astrocyte, and Microglia in PLX samples

```{r, eval = F, message=F, warning=F, results=F}
{
  counts.plx.00d <- read.table("../data/codes_for_CellChat/no_microglia_plx/counts_PLX5622_00d.txt", header = T)
  counts.plx.00d <- normalizeData(counts.plx.00d)
  meta.plx.00d <- read.table("../data/codes_for_CellChat/no_microglia_plx/meta_PLX5622_00d.txt", header = T)
  
  counts.plx.07d <- read.table("../data/codes_for_CellChat/no_microglia_plx/counts_PLX5622_07d.txt", header = T)
  counts.plx.07d <- normalizeData(counts.plx.07d)
  meta.plx.07d <- read.table("../data/codes_for_CellChat/no_microglia_plx/meta_PLX5622_07d.txt", header = T)
  
  counts.plx.28d <- read.table("../data/codes_for_CellChat/no_microglia_plx/counts_PLX5622_28d.txt", header = T)
  counts.plx.28d <- normalizeData(counts.plx.28d)
  meta.plx.28d <- read.table("../data/codes_for_CellChat/no_microglia_plx/meta_PLX5622_28d.txt", header = T)
}
...
```{r, eval = T, message=F, warning=F, results=F}
# plot diagrams in batch
mat.list <- Sys.glob("../data/codes_for_CellChat/no_microglia_plx/plx*_mat.csv") # the list of adjacency matrix files
cat.list <- Sys.glob("../data/codes_for_CellChat/no_microglia_plx/plx*_cat.csv") # the list of the gene category files, i.e., cell types
